...
class JoomlaquizHelper
{
    ...
    public static function addSubmenu($vName)
    {
        JHtmlSidebar::addEntry(
            JText::_('COM_JOOMLAQUIZ_SUBMENU_SETUP_CATEGORY'), 'index.php?option=com_categories&extension=com_joomlaquiz', $vName == 'quizcategories'
        );
        JHtmlSidebar::addEntry(
            JText::_('COM_JOOMLAQUIZ_SUBMENU_QUESTIONS_CATEGORY'), 'index.php?option=com_categories&extension=com_joomlaquiz.questions', $vName == 'questcategories'
        );
        JHtmlSidebar::addEntry(
            JText::_('COM_JOOMLAQUIZ_SUBMENU_SETUP_QUIZ'), 'index.php?option=com_joomlaquiz&view=quizzes', $vName == 'quizzes');
        JHtmlSidebar::addEntry(
            JText::_('COM_JOOMLAQUIZ_SUBMENU_SETUP_QUEST'), 'index.php?option=com_joomlaquiz&view=questions', $vName == 'questions');
    }
    ...
    public static function addQuizzesSubmenu($vName)
    {
        ...
        JHtmlSidebar::addEntry(
            JText::_('COM_JOOMLAQUIZ_SUBMENU_SETUP_QUIZ'), 'index.php?option=com_joomlaquiz&view=quizzes', $vName == 'quizzes');
        JHtmlSidebar::addEntry(
            JText::_('COM_JOOMLAQUIZ_SUBMENU_IMPORT_QUIZZES'), 'index.php?option=com_joomlaquiz&view=quizzes&layout=import_quizzes', $vName == 'import_quizzes'
        );
        JHtmlSidebar::addEntry(
            JText::_('COM_JOOMLAQUIZ_SUBMENU_SETUP_LPATH'), 'index.php?option=com_joomlaquiz&view=lpaths', $vName == 'lpaths'
        );
    }
    ...
    public static function addQuestionsSubmenu($vName)
    {
        ...
        JHtmlSidebar::addEntry(
            JText::_('COM_JOOMLAQUIZ_SUBMENU_SETUP_QUEST'), 'index.php?option=com_joomlaquiz&view=questions', $vName == 'questions');
        JHtmlSidebar::addEntry(
            JText::_('COM_JOOMLAQUIZ_SUBMENU_QUESTIONS_POOL'), 'index.php?option=com_joomlaquiz&view=questions&quiz_id=0', $vName == 'questions_pool'
        );
        JHtmlSidebar::addEntry(
            JText::_('COM_JOOMLAQUIZ_SUBMENU_UPLOAD_QUEST'), 'index.php?option=com_joomlaquiz&view=questions&layout=uploadquestions', $vName == 'uploadquestions'
        );
    }
    ...
    {
        JHtmlSidebar::addEntry(
            JText::_('COM_JOOMLAQUIZ_SUBMENU_MANUAL_PAYMENTS'), 'index.php?option=com_joomlaquiz&view=payments', $vName == 'payments'
        );
        JHtmlSidebar::addEntry(
            JText::_('COM_JOOMLAQUIZ_SUBMENU_REACTIVATE_ACCESS'), 'index.php?option=com_joomlaquiz&view=reactivates', $vName == 'reactivates');
        JHtmlSidebar::addEntry(
            JText::_('COM_JOOMLAQUIZ_SUBMENU_QUIZ_PRODUCTS'), 'index.php?option=com_joomlaquiz&view=products', $vName == 'products'
        );
    }
    ...
    {
        JHtmlSidebar::addEntry(
            JText::_('COM_JOOMLAQUIZ_SUBMENU_TEMPLATES'), 'index.php?option=com_joomlaquiz&view=templates', $vName == 'templates');
        JHtmlSidebar::addEntry(
            JText::_('COM_JOOMLAQUIZ_SUBMENU_CERTIFICATES'), 'index.php?option=com_joomlaquiz&view=certificates', $vName == 'certificates'
        );
    }
    ...
    {
        JHtmlSidebar::addEntry(
            JText::_('COM_JOOMLAQUIZ_SUBMENU_VIEW_REPORTS'), 'index.php?option=com_joomlaquiz&view=results', $vName == 'results'
        );
        JHtmlSidebar::addEntry(
            JText::_('COM_JOOMLAQUIZ_SUBMENU_VIEW_STATISTIC'), 'index.php?option=com_joomlaquiz&view=statistic', $vName == 'statistic');
        JHtmlSidebar::addEntry(
            JText::_('COM_JOOMLAQUIZ_SUBMENU_VIEW_DYNAMIC'), 'index.php?option=com_joomlaquiz&view=dynamic', $vName == 'dynamic'
        );
    }
