...
class JoomlaquizModelQuestions extends JModelList
{
    ...
    protected function populateState($ordering = 'ordering', $direction = 'ASC')
    {
        ...
        $quiz_id = $this->getUserStateFromRequest('questions.filter.quiz_id', 'filter_quiz_id', 0);
        //Data can be received either from the filter on the left or from the url.
        if(!$quiz_id) {
    ...
    protected function getListQuery()
    {
        ...
        $query->join('LEFT',
            '`#__extensions` as `e` ON (CONVERT (e.element USING utf8) COLLATE utf8_unicode_ci) = b.c_type');
