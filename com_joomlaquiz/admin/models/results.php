...
class JoomlaquizModelResults extends JModelList
{
    ...
    protected function populateState($ordering = null, $direction = null)
    {
        ...
        if (JFactory::getApplication()->input->get('layout') == 'stu_report' && 1 == 1) {
            $start = JFactory::getApplication()->input->get('stu_limitstart', '', $this->setState('list.start', $limit));
            JFactory::getApplication()->input->set('limitstart', $start);
            $this->setState('list.start', $start);
            $limit = JFactory::getApplication()->input->get('stu_limit', '', $this->setState('list.limit', $limit));
            JFactory::getApplication()->input->set('limit', $limit);
            $this->setState('list.limit', $limit);
            $direction = JFactory::getApplication()->input->get('stu_direction', '', $this->setState('list.direction', $limit));
            JFactory::getApplication()->input->set('direction', $direction);
            $this->setState('list.direction', $direction);
            $ordering = JFactory::getApplication()->input->get('stu_ordering', '', $this->setState('list.ordering', $limit));
