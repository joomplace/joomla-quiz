...
<?php echo $this->loadTemplate('menu'); ?>
    <form action="<?php echo JRoute::_('index.php?option=com_joomlaquiz&view=certificates'); ?>" method="post"
                ...
                <div class="btn-group pull-left hidden-phone">
                    <div class="pull-left">
                        <a class="btn" href="javascript:void(0)"
                           OnClick="Joomla.submitbutton('certificates.sample_certs')"><?php echo JText::_('COM_JOOMLAQUIZ_CERT_ADD_SAMPLE'); ?></a>
                    </div>
                </div>
                    ...
                    <?php foreach ($this->items as $i => $item) :
                        ...
                        <tr class="row<?php echo $i % 2; ?>" sortable-group-id="1">
                            ...
                            <td class="has-context">
                                <div class="pull-left">
                                    <a class="btn" href="javascript:void(0)"
                                       OnClick="window.open ('index.php?option=com_joomlaquiz&task=certificates.prev_cert&id=<?php echo $item->id; ?>','blank');return false;"><?php echo JText::_('COM_JOOMLAQUIZ_PREVIEW'); ?></a>
                                </div>
                            </td>
                        </tr>
                    <?php endforeach; ?>
