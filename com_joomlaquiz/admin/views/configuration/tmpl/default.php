...
?>
<a style="float: right; margin-top: 5px;" class="btn btn-small" href="#"
   onclick="Joomla.submitbutton('configuration.apply');"><?php echo JText::_('JTOOLBAR_APPLY'); ?></a>
<form action="<?php echo JRoute::_('index.php'); ?>" enctype="multipart/form-data" method="post" name="adminForm"
