...
<?php echo $this->loadTemplate('menu'); ?>
    <div id="pgm_dashboard">
        ...
        <div id="dashboard_items"><a
                    href="index.php?option=com_joomlaquiz&view=dashboard_items"><?php echo JText::_('COM_JOOMLAQUIZ_MANAGE_DASHBOARD_ITEMS'); ?></a>
        </div>
    </div>
    <div id="pgm_collapse">
        <div class="accordion" id="accordion2">
            <div class="accordion-group">
                <div class="accordion-heading">
                    <a style="text-decoration: underline !important;" class="accordion-toggle" data-toggle="collapse"
                        ...
                        <table border="1" width="100%" class="about_table">
                            <tr>
                                <th colspan="2" class="a_comptitle">
                                    <strong><?php echo JText::_('COM_JOOMLAQUIZ'); ?></strong> component for Joomla! 3.0
                                    Developed by
                            ...
                            <tr>
                                ...
                                <td align="left"><a target="_blank"
                                                    href="http://www.joomplace.com/forum/joomla-components/joomlaquiz-deluxe.html">http://www.joomplace.com/forum/joomla-components/joomlaquiz-deluxe.html</a>
                                </td>
                            </tr>
                            <tr>
                                <td align="left">Support Helpdesk:</td>
                                <td align="left"><a target="_blank"
                                                    href="http://www.joomplace.com/support/helpdesk/post-purchase-questions/ticket/create">http://www.joomplace.com/support/helpdesk/post-purchase-questions/ticket/create</a>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            <?php if ($this->errors) { ?>
                <div class="accordion-group">
                    <div class="accordion-heading" style="background: #DC0000;border-radius: 4px;">
                        <a style="color: #FFF;font-weight: bold;text-decoration: none!important;"
                    ...
                    <div class="accordion-inner">
                        <div class="thank_fdiv" style="font-size:12px;margin-left: 4px;">
                            ...
                            <a href="http://extensions.joomla.org/extensions/vertical-markets/education-a-culture/quiz/11302"
                               target="_blank">http://extensions.joomla.org/</a>
    ...
    <form action="<?php echo JRoute::_('index.php?option=com_joomlaquiz&view=dashboard'); ?>" method="post"
