...
<form action="<?php echo JRoute::_('index.php?option=com_joomlaquiz&view=dynamic'); ?>" enctype="multipart/form-data"
      method="post" name="adminForm" id="dynamic-form" class="form-validate">
    ...
    <div style="margin-top: 10px;" id="j-main-container" class="span10">
        ...
        <div style="margin-top: 10px;" id="j-main-container">
                ...
                <tr>
                    <td valign="top">
                        ...
                        <table border="0" align="center" valign="center">
                            <tr>
                                <td><?php echo JText::_('COM_JOOMLAQUIZ_AVAILABE_FIELDS'); ?></td>
                                <td></td>
                                <td><?php echo JText::_('COM_JOOMLAQUIZ_SELECTED_TO_INCLUDE_IN'); ?></td>
                            </tr>
                            <tr>
                                <td valign="top">
                                    <?php
                                    ...
                                    <input type="button" class="btn"
                                           value="<?php echo JText::_('COM_JOOMLAQUIZ_SELECT_ALL'); ?>"
                                           onclick="javascript: sel_all_fields();"/>
                                </td>
                                <td align="center" valign="middle">
                                    <input type="button" class="btn" value=">>"
                                           onclick="javascript: select_field();"/><br/>
                                    <input type="button" class="btn" value="<<"
                                           onclick="javascript: unselect_field();"/><br/>
                                    <br/>
                                    <input type="button" class="btn"
                                           value="<?php echo JText::_('COM_JOOMLAQUIZ_COPY_ALL'); ?>"
                                           onclick="javascript: copy_all();"/>
                                </td>
                                <td valign="top">
                                    <select name="selected_field[]" id="selected_field" multiple="multiple" size="10"
                                            style="width:250px">
                                    </select>
                                </td>
                            </tr>
            ...
            <br/>
            <strong>
                <small><?php echo JText::_('COM_JOOMLAQUIZ_PLEASE_SELECT_THE'); ?></small>
            </strong><br/>
            <br/>
