...
<form action="<?php echo JRoute::_('index.php?option=com_joomlaquiz&layout=edit&qc_id=' . (int)$this->item->qc_id); ?>"
      enctype="multipart/form-data" method="post" name="adminForm" id="questcategory-form" class="form-validate">
