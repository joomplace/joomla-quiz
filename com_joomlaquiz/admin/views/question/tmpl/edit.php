...
<script type="text/javascript">
    ...
    Joomla.submitbutton = function (task) {
        ...
        if (task == 'question.preview_quest') {
            if (!form.c_id.value) {
                alert("<?php echo JText::_('COM_JOOMLAQUIZ_PLEASE_SAVE_THE', true);?>");
                return false;
            } else {
...
<form action="<?php echo JRoute::_('index.php?option=com_joomlaquiz&layout=edit&c_id=' . (int)$this->item->c_id); ?>"
    ...
    <div id="j-main-container" class="span12 form-horizontal">
        <ul class="nav nav-tabs" id="questionTabs">
            <li class="active"><a href="#question-details"
                                  data-toggle="tab"><?php echo JText::_('COM_JOOMLAQUIZ_QUESTION'); ?></a></li>
            <?php if ($this->is_feedback): ?>
                <li><a href="#question-feedback"
                       data-toggle="tab"><?php echo JText::_('COM_JOOMLAQUIZ_QUESTION_FEEDBACK2'); ?></a></li>
            <?php endif; ?>
            <?php if ($this->options != ''): ?>
                <li><a href="#question-options"
                       data-toggle="tab"><?php echo JText::_('COM_JOOMLAQUIZ_QUESTION_OPTIONS'); ?></a></li>
            <?php endif; ?>
                ...
                <fieldset class="adminform">
                    ...
                    if (count($this->add_form)) {
                        foreach ($this->add_form as $for => $item) {
                            ?>
                            <div class="control-group">
                                <label class=" control-label" for="<?php echo $for; ?>" id="<?php echo $for; ?>-lbl"
                    ...
                    <fieldset class="adminform">
                        ...
                        <?php if ($this->feedback_fields): ?>
                            <?php foreach ($this->feedback_fields as $for => $field): ?>
                                <div class="control-group">
                                    <label class=" control-label" for="<?php echo $for; ?>" id="<?php echo $for; ?>-lbl"
                                           style="width:156px;"><?php echo $field['label'] ?></label>
                                    <div class="controls">
