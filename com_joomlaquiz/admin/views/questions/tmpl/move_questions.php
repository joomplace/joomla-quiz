...
<form action="<?php echo JRoute::_('index.php?option=com_joomlaquiz&layout=move_questions'); ?>" enctype="multipart/form-data" method="post" name="adminForm" id="questions-form" class="form-validate">
	<div id="j-main-container" class="span10 form-horizontal">
		<fieldset>
			...
			<table class="table table-striped" id="quizzesList" style="margin-top:20px;">
				...
				<tbody>
				<?php foreach ($this->move_questions as $i => $item) :?>
