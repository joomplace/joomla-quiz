...
<form action="<?php echo JRoute::_('index.php?option=com_joomlaquiz&view=templates&layout=edit_css&cid=' . $this->cid); ?>"
                            ...
                            <tr>
                                <td width="280">
                                    <table class="adminheading">
                                        <tr>
                                            <th class="templates"><?php echo JText::_('COM_JOOMLAQUIZ_TEMPLATE_CSSEDITOR'); ?></th>
                                        </tr>
                                    </table>
                                </td>
                                <td width="260">
