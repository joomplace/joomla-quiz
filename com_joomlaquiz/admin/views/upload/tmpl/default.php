...
<body onload="load()">
<form method="post" action="<?php echo JRoute::_('index.php?option=com_joomlaquiz&task=hotspot.uploadimage'); ?>"
      enctype="multipart/form-data" name="filename" id="filename">
