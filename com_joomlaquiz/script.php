...
class com_joomlaquizInstallerScript
{
    ...
    function update($parent)
    {
		...
		if(!$db->loadResult()){
			...
			(1, 'Manage Quizzes', 'index.php?option=com_joomlaquiz&view=quizzes', '".JURI::root()."/administrator/components/com_joomlaquiz/assets/images/quizzes48.png', 1),
			(2, 'Manage Questions', 'index.php?option=com_joomlaquiz&view=questions', '".JURI::root()."/administrator/components/com_joomlaquiz/assets/images/questions48.png', 1),
			(3, 'Help', 'https://www.joomplace.com/video-tutorials-and-documentation/joomla-quiz-deluxe-3.0/index.html', '".JURI::root()."/administrator/components/com_joomlaquiz/assets/images/help48.png', 1);");
			$db->execute();
		} else {
            $query = $db->getQuery(true);
