...
JLoader::registerNamespace('Joomplace\Component\Joomlaquiz\Site',JPATH_SITE.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_joomlaquiz',false,false,'psr4');
$input = JFactory::getApplication()->input;
$component = new \Joomplace\Component\Joomlaquiz\Site\Dispatcher();
