...
foreach ($this->categories as $categ) {
    ...
    ?>
<div class="contentpane <?php echo (!$parent) ? 'child-cat' : 'parent-cat';
echo ' rel-level' . $cat->level; ?> joomlaquiz">
            ...
            <?php foreach ($rows as $row) { ?>
                <div class="jq_cat_quiz_title">
                    ...
                    <?php if ($row->c_short_description) { ?>
                        <div class="jq_cat_quiz_expand" style="float:right;">
                ...
                foreach ($bought_quizzes as $b_quizz) {
                    ...
                    <div class="jq_cat_pquiz_title">
                        ...
                        <?php if ($b_quizz->row->c_short_description) { ?>
                            <div class="jq_cat_pquiz_expand" style="float:right;">
                                [<?php echo JText::_('COM_JQ_SHOW_DESCRIPTION'); ?>]
                            </div>
                        <?php } ?>
                    </div>
                ...
                foreach ($lpaths as $lpath) {
                    ...
                    <div class="jq_cat_lpath_title">
                        ...
                        <?php if ($lpath->short_descr) { ?>
                            <div class="jq_cat_lpath_expand" style="float:right;">
                                [<?php echo JText::_('COM_JQ_SHOW_DESCRIPTION'); ?>]
                            </div>
                        <?php } ?>
                    </div>
