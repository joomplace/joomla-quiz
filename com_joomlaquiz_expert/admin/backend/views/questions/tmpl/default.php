				...
				<tr class="row<?php echo $i % 2; ?>" sortable-group-id="1" id="quest_row_<?php echo $item->c_id;?>">
					...
					<td class="nowrap has-context">
                        ...
                        <?php
                            ...
                            <a title="<?php echo $this->escape(strip_tags($item->c_question)); ?>" href="<?php echo JRoute::_('index.php?option=com_joomlaquiz&task=question.edit&c_id='.$item->c_id);?>"><?php echo $this->escape($question); ?></a>
                        <?php else : ?>
