    ...
    */
    ...
    {        	
        ...
        if($layout == 'stu_report'){					
			...
			$query->select("q.c_credit, sq.user_email, sq.user_name, sq.unique_id, sq.unique_pass_id, sq.c_id, sq.c_passed, sq.c_total_score,sq.c_max_score as c_full_score, sq.c_total_time, sq.c_date_time, sq.params, sq.c_passed,q.c_title, q.c_author, q.c_passing_score, sq.c_student_id, u.username, u.name, u.email, q.c_pool, ch.q_chain");
