...
<form action="<?php echo JRoute::_('index.php?option=com_joomlaquiz&view=addons'); ?>" enctype="multipart/form-data"
      method="post" name="adminForm" id="addons-form" class="form-validate">
        ...
        <div id="j-main-container">
            ...
            <fieldset class="adminform">
                ...
                <div class="control-group form-inline">
                    <label class="control-label" for="jform_userfile" id="jform_userfile-lbl"
