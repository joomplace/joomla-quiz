...
<form action="<?php echo JRoute::_('index.php?option=com_joomlaquiz&layout=edit&id=' . (int)$this->item->id); ?>"
      enctype="multipart/form-data" method="post" name="adminForm" id="certificate-form" class="form-validate">
    <div id="j-main-container" class="span10 form-horizontal">
        <fieldset class="adminform">
            ...
            <div style="margin:15px;font-size:18px;">
                To see how to create a certificate with all the necessary data included, see our online manual <a
                        href="http://www.joomplace.com/video-tutorials-and-documentation/joomla-quiz-deluxe/certificates.htm"
            ...
            <div class="control-group form-inline">
                <label class="required control-label" for="jform_cert_file" id="jform_cert_file-lbl"
                       aria-invalid="false"><?php echo JText::_('COM_JOOMLAQUIZ_IMAGE') ?><span
                ...
                <div class="controls">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td>
                                <?php echo $this->lists['images'] ?></td>
                            <td style="padding-left:10px;"><a href="#"
                                                              onclick="window.open('index.php?tmpl=component&option=com_joomlaquiz&amp;task=hotspot.uploadimage&amp;directory=<?php echo $directory; ?>&amp;t=<?php echo $cur_template; ?>','win1','width=450,height=200');"
                                                              class="btn"><?php echo JText::_('COM_JOOMLAQUIZ_UPLOAD_NEWIMAGE') ?></a>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="control-group form-inline">
                <label class=" required control-label" for="jform_text_font" id="jform_text_font-lbl"
                       aria-invalid="false"><?php echo JText::_('COM_JOOMLAQUIZ_FONT') ?><span
                            class="star"></span></label>
                <div class="controls">
                ...
                <table class="table table-striped" id="qfld_tbl">
                    ...
                    foreach ($this->lists['fields'] as $field) { ?>
                        <tr class="<?php echo "row$k"; ?>">
                            <td align="left">
                                <input size="30" type="text" name="jq_hid_fields[]"
                                       value="<?php echo htmlspecialchars(stripslashes($field->f_text)) ?>"/>
                                <input type="hidden" name="jq_hid_fields_ids[]" value="<?php echo $field->c_id ?>"/>
                            </td>
                            <td>
                                <a href="javascript: void(0);" onClick="javascript:Delete_tbl_row(this); return false;"
                                   title="Delete"><img
                            ...
                            <td>
                                <input type="checkbox"
                                       name="dummy[]" <?php echo($field->shadow ? 'checked="checked"' : '') ?> value="1"
                                       onchange="javascript: if(this.checked){getObj('jq_fields_shadow_<?php echo $field->c_id ?>').value=1} else{getObj('jq_fields_shadow_<?php echo $field->c_id ?>').value=0}"/>
                                <input type="hidden" id="jq_fields_shadow_<?php echo $field->c_id ?>"
                                       name="jq_fields_shadow[]" value="<?php echo $field->shadow ?>"/>
                            </td>
                            <td><input type="text" name="jq_hid_field_x[]" value="<?php echo $field->text_x ?>"
                                       size="4"/></td>
                            <td><input type="text" name="jq_hid_field_y[]" value="<?php echo $field->text_y ?>"
                                       size="4"/></td>
                            <td><input type="text" name="jq_hid_field_h[]" value="<?php echo $field->text_h ?>"
                                       size="4"/></td>
                ...
                <table class="table table-striped">
                    <tr>
                        ...
                        <td align="center" width="7%">
                            <label for="new_shadow"><input type="checkbox" name="new_shadow" id="new_shadow" value="1"/>&nbsp;<?php echo JText::_('COM_JOOMLAQUIZ_SHADOW'); ?>
                            </label>
                        </td>
                        ...
                        <td>
                            <input class="btn" type="button" name="add_new_field" style="width:70px " value="Add"
                                   onClick="javascript:Add_new_tbl_field();"/>
                        </td>
                    </tr>
                </table>
            </div>
