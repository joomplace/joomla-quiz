...
<form action="<?php echo JRoute::_('index.php?option=com_joomlaquiz&layout=edit&id=' . (int)$this->item->id); ?>"
      enctype="multipart/form-data" method="post" name="adminForm" id="lpath-form" class="form-validate">
    <div id="j-main-container" class="span10 form-horizontal">
        <ul class="nav nav-tabs" id="quizTabs">
            <li class="active"><a href="#basic"
                                  data-toggle="tab"><?php echo JText::_('COM_JOOMLAQUIZ_LP_BASIC_SETTINGS'); ?></a></li>
            <li><a href="#permissions"
                   data-toggle="tab"><?php echo JText::_('COM_JOOMLAQUIZ_LP_PERMISSIONS_SETTINGS'); ?></a></li>
        </ul>
            ...
            <div class="tab-pane active" id="basic">
                ...
                <fieldset class="adminform">
                    ...
                    <table class="adminlist" id="qfld_tbl" cellpadding="10" cellspacing="10">
                        ...
                        $k = 0;
                        $ii = 1;
                        $ind_last = count($this->lpaths_data);
                        foreach ($this->lpaths_data as $frow) { ?>
                            <tr class="<?php echo "row$k"; ?>">
                                ...
                                <td align="left">
                                    ...
                                    <input type="hidden" name="jq_hid_fields_types[]"
                                           value="<?php echo $frow->type; ?>"/>
                                </td>
                                <td align="center">
                                    <?php echo($frow->type == 'q' ? 'Quiz' : 'Article'); ?>
                                </td>
                                <td><a href="javascript: void(0);"
                                       onclick="javascript:Delete_tbl_row(this); return false;" title="Delete"><img
                                                src="<?php echo JURI::root() ?>administrator/components/com_joomlaquiz/assets/images/publish_x.png"
                                                border="0" alt="Delete"></a></td>
                                <td><?php if ($ii > 1) { ?><a href="javascript: void(0);"
                                                              onclick="javascript:Up_tbl_row(this); return false;"
                                                              title="Move Up"><img
                                                src="<?php echo JURI::root() ?>administrator/components/com_joomlaquiz/assets/images/uparrow.png"
                                                border="0" alt="Move Up"></a><?php } ?></td>
                                <td><?php if ($ii < $ind_last) { ?><a href="javascript: void(0);"
                                                                      onclick="javascript:Down_tbl_row(this); return false;"
                                                                      title="Move Down"><img
                                                src="<?php echo JURI::root() ?>administrator/components/com_joomlaquiz/assets/images/downarrow.png"
                                                border="0" alt="Move Down"></a><?php } ?></td>
                                <td></td>
                            </tr>
                            <?php
                            $k = 1 - $k;
                        ...
                        <tr>
                            <td>
                                <div style="text-align:left; padding-left:30px ">
                                    ...
                                    <input class="modal-button btn" type="button" name="add_new_field"
                                           style="width:100px "
                                           value="<?php echo JText::_('COM_JOOMLAQUIZ_ADD_QUIZ'); ?>"
                                           onclick="javascript:Add_new_tbl_field('quiz_id', 'qfld_tbl', 'jq_hid_fields_ids[]', 'jq_hid_fields_types[]');"/>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <?php echo $this->quizzes_data['articles_list']; ?>
                                    <input class="modal-button btn" type="button" name="add_new_field"
                                           style="width:100px "
                                           value="<?php echo JText::_('COM_JOOMLAQUIZ_ADD_ARTICLE'); ?>"
                                           onclick="javascript:Add_new_tbl_field('article_id', 'qfld_tbl', 'jq_hid_fields_ids[]', 'jq_hid_fields_types[]');"/>
                                </div>
                            </td>
                        </tr>
                    </table>
...
<script type="text/javascript">
    ...
    function Add_new_tbl_field(elem_field, tbl_id, field_name, field_type) {
        ...
        if (TRIM_str(new_element_id) < 1) {
            alert("<?php echo JText::_('COM_JOOMLAQUIZ_PLEASE_SELECT_A');?> " + elem_type_names[elem_type] + ".");
            return;
        }
