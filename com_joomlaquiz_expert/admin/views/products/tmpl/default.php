...
<?php echo $this->loadTemplate('menu');?>
    <form action="<?php echo JRoute::_('index.php?option=com_joomlaquiz&view=products'); ?>" method="post" name="adminForm" id="adminForm">
            ...
            <div style="margin-top: 10px;" id="j-main-container">
                ...
                <table class="table table-striped" id="productList">
                    ...
                    <?php if(sizeof($this->items)){foreach ($this->items as $i => $item) :
                        $link 	= JRoute::_('index.php?option=com_joomlaquiz&task=product.edit&pid='.$item->pid . '_' . $item->pid_type. '&id=' . $item->id);
