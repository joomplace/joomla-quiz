...
<form action="<?php echo JRoute::_('index.php?option=com_joomlaquiz&layout=copy_questions_cat'); ?>" enctype="multipart/form-data" method="post" name="adminForm" id="questions-form" class="form-validate">
	...
	<div id="j-main-container" class="span10 form-horizontal">
		<fieldset>
			...
			<table class="table table-striped" id="quizzesList" style="margin-top:20px;">
				...
				<tbody>
				<?php foreach ($this->copy_questions_cat as $i => $item) :?>
					<tr class="row<?php echo $i % 2; ?>" sortable-group-id="1">
						...
						<td class="nowrap has-context">
							<div class="pull-left">
								<?php echo JoomlaquizHelper::jq_substr($item->c_question, 0, 150);?>
							</div>
						</td>
						<td class="nowrap has-context">
							<div class="pull-left">
