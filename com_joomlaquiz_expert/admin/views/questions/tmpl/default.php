...
?>
    ...
    <script language="javascript" type="text/javascript"
            src="<?php echo JURI::root(); ?>administrator/components/com_joomlaquiz/assets/js/thickbox/thickbox.js"></script>
...
<?php echo $this->loadTemplate('menu'); ?>
    <form action="<?php echo JRoute::_('index.php?option=com_joomlaquiz&view=questions'); ?>" method="post"
                ...
                <div id="filter-bar" class="btn-toolbar">
                    <div class="filter-search btn-group pull-left">
                        ...
                        <input type="text" name="filter_search"
                               placeholder="<?php echo JText::_('COM_JOOMLAQUIZ_FILTER_SEARCH_DESC'); ?>"
                               id="filter_search"
                    ...
                    <?php if (sizeof($this->items)) {
                        foreach ($this->items as $i => $item) :
                            ...
                            <tr class="row<?php echo $i % 2; ?>" sortable-group-id="1"
                                id="quest_row_<?php echo $item->c_id; ?>">
                                ...
                                <td>
                                    ...
                                    <?php } else { ?>
                                        <i class="icon-unpublish "
                                           onclick="deleteInvalidQuestion(<?php echo $item->c_id; ?>)"
                                ...
                                <td class="nowrap has-context">
                                    <div>
                                        ...
                                        if ($canEdit && $item->enabled) : ?>
                                            <a title="<?php echo $this->escape($item->c_question); ?>"
                                               href="<?php echo JRoute::_('index.php?option=com_joomlaquiz&task=question.edit&c_id=' . $item->c_id); ?>"><?php echo $this->escape($question); ?></a>
                                        <?php else : ?>
                                ...
                                <td class="has-context">
                                    <?php if ($item->enabled): ?>
                                        ...
                                        if ($app->getUserStateFromRequest('quizzes.filter.quiz_id', 'filter_quiz_id') > 0 && !(in_array($item->c_id, $this->pbreaks))) { ?>
                                            <a class="btn" style="color:#009900" title="Add page break"
                                               href="index.php?option=com_joomlaquiz&task=questions.add_pbreak&quiz_id=<?php echo $item->c_quiz_id; ?>&quest_id=<?php echo $item->c_id; ?>"><?php echo JText::_('COM_JOOMLAQUIZ_ADD_PAGE_BREAK'); ?></a>
                                        <?php } ?>
                                    <?php endif; ?>
                                </td>
                            </tr>
                            ...
                            if ($app->getUserStateFromRequest('quizzes.filter.quiz_id', 'filter_quiz_id') > 0 && in_array($item->c_id, $this->pbreaks)) {
                                ...
                                <tr class="<?php echo "row$k"; ?>">
                                    ...
                                    <td><a class="btn" style="color:#990000" title="Remove page break"
                                           href="index.php?option=com_joomlaquiz&task=questions.delete_pbreak&pid=<?php echo $item->c_id; ?>"><?php echo JText::_('COM_JOOMLAQUIZ_REMOVE_PAGE_BREAK'); ?></a>
                                    </td>
                                </tr>
                                <?php
                            }
                    ...
                    <?php } else { ?>
                        <tr>
                            <td colspan="10" align="center">
                                ...
                                <a onclick="javascript: tb_start(this);return false;"
                                   href="index.php?option=com_joomlaquiz&amp;tmpl=component&amp;task=questions.new_question_type&amp;KeepThis=true&amp;TB_iframe=true&amp;height=350&amp;width=700"
                                   href="#">
