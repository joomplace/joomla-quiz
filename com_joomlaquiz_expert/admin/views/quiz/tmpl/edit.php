...
<form action="<?php echo JRoute::_('index.php?option=com_joomlaquiz&layout=edit&c_id=' . (int)$this->item->c_id); ?>"
    ...
    <div id="j-main-container" class="span12 form-horizontal">
        <ul class="nav nav-tabs" id="quizTabs">
            <li class="active"><a href="#quiz-details"
                                  data-toggle="tab"><?php echo JText::_('COM_JOOMLAQUIZ_QUIZ_DETAILS'); ?></a></li>
            <li><a href="#quiz-description"
                   data-toggle="tab"><?php echo JText::_('COM_JOOMLAQUIZ_QUIZ_DESCRIPTION'); ?></a></li>
            <li><a href="#additional-option"
                   data-toggle="tab"><?php echo JText::_('COM_JOOMLAQUIZ_ADDITIONAL_OPTIONS'); ?></a></li>
            <li><a href="#feedback-option"
                   data-toggle="tab"><?php echo JText::_('COM_JOOMLAQUIZ_FEEDBACK_OPTIONS'); ?></a></li>
            <li><a href="#question-pool-option"
                   data-toggle="tab"><?php echo JText::_('COM_JOOMLAQUIZ_QUESTION_POOL_OPTIONS'); ?></a></li>
            <li><a href="#metadata-information"
                   data-toggle="tab"><?php echo JText::_('COM_JOOMLAQUIZ_METADATA_INFORMATION'); ?></a></li>
            <li><a href="#quiz-permission"
                   data-toggle="tab"><?php echo JText::_('COM_JOOMLAQUIZ_QUIZ_PERMISSION'); ?></a></li>
        </ul>
        ...
        <fieldset class="adminform">
            ...
            <div class="control-group">
                ...
                <table cellpadding="0"
                    ...
                    <tr>
                        <td>
                            <?php echo JText::_('COM_JOOMLAQUIZ_IF_RECEIVED'); ?><input type="text" id="q_rfrom"
                                                                                        name="q_rfrom" maxlength="3"
                                                                                        style="margin-left:15px;"/>
                        </td>
                        <td>
                            &nbsp;<?php echo JText::_('COM_JOOMLAQUIZ_TO'); ?>&nbsp;<input type="text" id="q_rto"
                                                                                           name="q_rto" maxlength="3"/>
                        </td>
                        <td>
    ...
    <div class="tab-pane" id="question-pool-option">
        <fieldset class="adminform">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" size="10" value="<?php echo $this->q_count; ?>" id="jform_pool_rand"
                           name="jform[pool_rand]" class="" aria-invalid="false">
                </div>
            </div>
            <div class="control-group">
...
<script type="text/javascript">
    ...
    document.getElementById('jform_c_feed_option').onchange = function () {
        if (document.getElementById('jform_c_feed_option').value == 0) {
            document.getElementById('feed_toins').style.display = 'none';
            document.getElementById('by_score_id').style.display = 'none';
        } else {
