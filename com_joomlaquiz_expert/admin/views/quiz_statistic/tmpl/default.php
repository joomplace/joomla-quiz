                ...
                <tr>
                    ...
                    <td align="center">
                        <div class="progress progress-striped active">
                            <div class="bar"
                                 style="width: <?php echo number_format($row->progress * 100, 0) ?>%;"></div>
                        </div>
                    </td>
                    ...
                    <td style="text-align: center;">
                        <?php echo JHtml::_('date.relative', $row->start_at, null, JFactory::getDate()); ?>
                        (<?php echo JHtml::_('date', $row->start_at, 'H:i:s'); ?>)
                    </td>
                </tr>
            <?php endforeach; ?>
        <?php endif; ?>
