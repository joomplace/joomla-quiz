...
<form action="<?php echo JRoute::_('index.php?option=com_categories&extension=com_joomlaquiz'); ?>" method="post" name="adminForm" id="adminForm">
                                ...
                                <td>
                                    <div class="pull-left">
                                        ...
                                        if ($canEdit) :
                                            ...
                                            ?>
                                            <a title="<?php echo $this->escape(strip_tags($item->c_category)); ?>" href="<?php echo JRoute::_('index.php?option=com_joomlaquiz&task=quizcategory.edit&c_id=' . $item->c_id); ?>">
