...
<?php echo $this->loadTemplate('menu'); ?>
    <form action="<?php echo JRoute::_('index.php?option=com_joomlaquiz&view=quizzes'); ?>" method="post"
							...
							<i class="icon-menu"><?php echo($i + 1); ?></i>
                                ...
                                <td class="has-context">
                                    <div>
                                        ...
                                        if ($canEdit) : ?>
                                            <a title="<?php echo $this->escape($item->c_title); ?>"
                                               href="<?php echo JRoute::_('index.php?option=com_joomlaquiz&task=quiz.edit&c_id=' . $item->c_id); ?>"><?php echo $this->escape($quiz); ?></a>
