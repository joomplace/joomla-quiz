...
<?php echo $this->loadTemplate('menu'); ?>
    <form action="<?php echo JRoute::_('index.php?option=com_joomlaquiz&layout=import_quizzes'); ?>"
          enctype="multipart/form-data" method="post" name="adminForm" id="quizzes-form" class="form-validate">
            ...
            <div id="j-main-container">
                ...
                <fieldset class="adminform" style="margin-top: -15px">
                    ...
                    <div class="control-group form-inline">
                        <label class="control-label" for="jform_importme" id="jform_importme-lbl"
                               aria-invalid="false"><?php echo JText::_('COM_JOOMLAQUIZ_LOAD_FILE') ?></label>
                        <div class="controls">
                    ...
                    <div class="control-group form-inline">
                        <label class="control-label" for="jform_importme" id="jform_importme-lbl"
                               aria-invalid="false"><?php echo JText::_('COM_JOOMLAQUIZ_INCLUDE_POOL') ?></label>

                        <div class="controls">
                            <fieldset class="radio btn-group" id="jform_imp_pool">
                                <input type="radio" checked="checked" value="0" name="jform[imp_pool]"
                                       id="jform_imp_pool0">
                                <label for="jform_imp_pool0" id="lbl_jform_imp_pool0"
                                       class="btn active"><?php echo JText::_('COM_JOOMLAQUIZ_NO') ?></label>
                                <input type="radio" value="1" name="jform[imp_pool]" id="jform_imp_pool1">
                                <label for="jform_imp_pool1" id="lbl_jform_imp_pool1"
                                       class="btn"><?php echo JText::_('COM_JOOMLAQUIZ_YES') ?></label>
                            </fieldset>
                        </div>
                    </div>
