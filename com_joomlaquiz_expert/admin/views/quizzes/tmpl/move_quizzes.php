...
<form action="<?php echo JRoute::_('index.php?option=com_joomlaquiz&layout=move_quizzes'); ?>" enctype="multipart/form-data" method="post" name="adminForm" id="quizzes-form" class="form-validate">
	<div id="j-main-container" class="span10 form-horizontal">
		<fieldset>
			<legend><?php echo JText::_('COM_JOOMLAQUIZ_MOVE_QUIZZES');?></legend>
			<div style="float:left;margin-right:10px;">
				<strong><?php echo JText::_('COM_JOOMLAQUIZ_COPY_MOVE');?></strong>
			</div>
			<div style="float:left;margin-right:10px;">
				<label for="categorymove" class="element-invisible"><?php echo JText::_('COM_JOOMLAQUIZ_FILTER');?></label>
			...
			<table class="table table-striped" id="quizzesList" style="margin-top:20px;">
				...
				<tbody>
				<?php foreach ($this->move_quizzes as $i => $item) :?>
