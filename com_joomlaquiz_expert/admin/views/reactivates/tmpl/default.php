...
<?php echo $this->loadTemplate('menu'); ?>
    <form action="<?php echo JRoute::_('index.php?option=com_joomlaquiz&view=reactivates'); ?>" method="post"
                        ...
                        <tr class="row<?php echo $i % 2; ?>" sortable-group-id="1">
                            <td class="order nowrap center">
                                ...
                                <input type="text" style="display:none" name="order_id" size="5"
                                       value="<?php echo($item->vm ? $item->order_id : $item->order_id + 1000000000); ?>"
