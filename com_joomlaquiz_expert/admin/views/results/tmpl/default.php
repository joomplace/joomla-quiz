...
<?php echo $this->loadTemplate('menu'); ?>
    <form action="<?php echo JRoute::_('index.php?option=com_joomlaquiz&view=results'); ?>" method="post"
                    ...
                    <?php foreach ($this->items as $i => $item) :
                        ...
                        */
                        ...
                        <tr class="row<?php echo $i % 2; ?>" sortable-group-id="1">
                            ...
                            <td class="has-context">
                                <div class="pull-left">
                                    <img src="<?php echo JURI::root() ?>administrator/components/com_joomlaquiz/assets/images/<?php echo $img_passed; ?>"
