...
<?php echo $this->loadTemplate('menu'); ?>
    <form action="<?php echo JRoute::_('index.php?option=com_joomlaquiz&view=statistic'); ?>" method="post"
                                ...
                                <tr>
                                    <td colspan="2">
                                        <table>
                                            <tr>
                                                <td width="400">
                                                    <strong><?php echo JText::_('COM_JOOMLAQUIZ_OPTIONS'); ?></strong>
                                                </td>
                                                <td width="50">
                                                    <strong><?php echo JText::_('COM_JOOMLAQUIZ_COUNT'); ?></strong>
                                                </td>
                                                <td width="100">&nbsp;</td>
                                                <td width="300">&nbsp;</td>
                                            </tr>
