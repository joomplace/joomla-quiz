...
class JoomlaquizControllerResultscategory extends JControllerForm
{
  	public function getModel($name = 'resultscategory', $prefix = '', $config = array('ignore_request' => true))
	{
