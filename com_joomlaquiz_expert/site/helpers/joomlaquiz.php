...
class JoomlaquizHelper
{
    ...
    public static function poweredByHTML()
    {
        ...
        if (JComponentHelper::getParams('com_joomlaquiz')->get('jq_show_dev_info', 0)) {
            $word = 'component';
            if (intval(md5(JPATH_SITE . 'quiz')) % 2 == 0)
                $word = 'extension';
    ...
    public static function JQ_checkPackage($package_id, $rel_id, $vm = 1)
    {
        ...
        } else if (($product_data->period_start && $product_data->period_start != '0000-00-00') || ($product_data->period_end && $product_data->period_end != '0000-00-00')) {
