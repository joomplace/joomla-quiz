...
{	
	...
	public function JQ_StartQuiz() {
		...
		if ($quiz_id) {
			...
			. "\n VALUES('".$package_id."', '".$rel_id."', '".$lid."', '".$quiz_id."', '".$my->id."', '0', '0', '".$quiz_time."', '0', '".$user_unique_id."', '".$unique_pass_id."', 0, '".$user_email."', '".$user_name." ".$user_surname."', '".$user_surname."', ".$database->quote($cust_params).")";
				$database->SetQuery($query);
				$database->query();
