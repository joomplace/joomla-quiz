            ...
            if (($quiz_id == $start_quiz)) {
                ...
                for ($q = 0, $qn = count($quest_ids); $q < $qn; $q++) {
                    ...
                    if ($question[0]->c_partially_message)
                        $jq_language['COM_QUIZ_PARTIALLY_CORRECT'] = htmlspecialchars($question[0]->c_partially_message);
                    elseif ($question[0]->c_wrong_message)
                        $jq_language['COM_QUIZ_PARTIALLY_CORRECT'] = htmlspecialchars($question[0]->c_wrong_message);
                    else
                    ...
                    if ($got_one_correct) {
                        if ($question[0]->c_partially_message)
                            $jq_language['COM_QUIZ_ANSWER_INCORRECT'] = htmlspecialchars($question[0]->c_partially_message);
                    }
