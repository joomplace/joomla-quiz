...
<?php if (!$this->result['is_available']): ?>
    ...
    <?php if ($this->result['error_code'] == '0001'): ?>
        <p align="left"><?php echo JText::_('COM_QUIZ_NOT_AVAILABLE') ?><br/>(Error code: 0001 - Template for quiz not
            found.)</p>
    ...
    <?php if ($this->result['error_code'] == '0003'): ?>
        <p align="left"><?php echo JText::_('COM_QUIZ_NOT_AVAILABLE') ?><br/>(Error code: 0003 - You have no permissions
            to preview this question.)</p>
        <?php echo JoomlaquizHelper::poweredByHTML(); ?>
    <?php endif; ?>
