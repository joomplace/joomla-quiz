            ...
            <table class="jq_statistics_container_table" width="100%">
                ...
                <tr>
                    <td class="sectiontableheader"
                        colspan="2"><?php echo JText::_('COM_STATISTICS_QUIZ_SUMMARY'); ?></td>
                </tr>
                </thead>
                <tbody>
                <tr>
                ...
                foreach ($questions as $i => $question) { ?>
                    ...
                    <tr>
                        <td colspan="2">
                            <table>
                                <tr>
                                    <td width="400"><strong><?php echo JText::_('COM_STATISTICS_OPTIONS'); ?></strong>
                                    </td>
                                    <td width="50" align="center">
                                        <strong><?php echo JText::_('COM_STATISTICS_COUNT'); ?></strong></td>
                                    <td width="100">&nbsp;</td>
                                    <td width="300">&nbsp;</td>
                                </tr>
                                <?php
