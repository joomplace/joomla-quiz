...
foreach ($result as $one_res) {
	echo "<tr><td class='sectiontableentry".$sec_tbl.$moduleclass_sfx."'><div style='width:100%; overflow:hidden'><a href='".JRoute::_('index.php?option=com_joomlaquiz&view=quiz&quiz_id='.$one_res->qid)."'>".$one_res->c_title."</a></td><td class='sectiontableentry".$sec_tbl.$moduleclass_sfx."'>".$one_res->c_total_score."</div></td></tr>";
