...
<script language="javascript" type="text/javascript">
        ...
        function new_blnk_tbl() {
			...
			rem_th1.innerHTML = '<strong>Blank <span id="blnk_num_'+(tbl_count-1)+'">' + tbl_count +
    '</span></strong>, code for question text: {blank'+tbl_count+'}<br />\'All answers of the block (Acceptable & ' +
    'Distractors)\' - code for question text: {answers'+tbl_count+'}';
