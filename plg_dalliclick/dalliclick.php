...
class plgJoomlaquizDalliclick extends plgJoomlaquizQuestion
{
	...
	public function onCreateQuestion(&$data) {
        ...
        $qhtml = ($data['q_data']->c_image) ? "<div class='dc_layout'><div class='dc_cover_container' style='position: relative;display: block!important;'><div class='cover' style='position: absolute;display: grid; grid-template-columns: repeat(5, 1fr); width: 100%; height: 100%;'><div class='pause'><!--x--></div><input type='hidden' value='".$dc_img."' id='imgSrc' /></div><canvas id='dc_image' class='dc_image' style='position:relative!important;width: 100%;vertical-align: bottom;'></canvas></div> \n" : "";
