		...
		if($isMobile){
			...
			$jq_tmpl_html = '
				...
				<div id="foo_'.$review_data['quest_id'].'" style="margin-top:15px;">
					...
					<image data-scale="initial" x="0" y="0" width="'.$review_data['width'].'" height="'.$review_data['height'].'" preserveAspectRatio="none" xlink:href="'.JURI::root().'images/joomlaquiz/images/'.$review_data['c_image'].'"/>
					'.$path_str.'
					<circle data-scale="initial" cx="'.$review_data['c_select_x'].'" cy="'.$review_data['c_select_y'].'" r="5" fill="#ffa500" stroke="#ff0000" style=""/>
					</svg>
				</div>';
