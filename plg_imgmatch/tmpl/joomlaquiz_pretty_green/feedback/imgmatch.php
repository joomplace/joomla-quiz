...
class JoomlaquizViewFeedbackImgmatch
{
    public static function getFeedbackContent($qdata, $data)
    {
        ...
        if(is_array($qdata)) {
            foreach ($qdata as $t) {
                $correct = ($t['c_correct']) ? '<img src="'.JURI::root().'components/com_joomlaquiz/views/templates/tmpl/joomlaquiz_pretty_green/images/result_true_green.png"/>' : '<img src="'.JURI::root().'components/com_joomlaquiz/views/templates/tmpl/joomlaquiz_pretty_green/images/result_false.png"/>';
