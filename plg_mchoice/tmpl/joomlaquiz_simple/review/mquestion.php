 ...
 */
class JoomlaquizViewReviewMchoice
{
	public static function getReviewContent($review_data, $data){
	
		$jq_tmpl_html = "<table align='left' class='jq_mchoices'>" . "\n";
		foreach ($review_data as $qone) {
			$jq_tmpl_html .= "<tr>"
				...
				. (isset($qone->statistic_true)? $qone->statistic_true: '')
				...
				. (isset($qone->statistic_false)? $qone->statistic_false: '')
				. "</td>"
				. "\n";
