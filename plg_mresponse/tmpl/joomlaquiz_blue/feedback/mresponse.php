...
class JoomlaquizViewFeedbackMresponse
{
	public static function getFeedbackContent($feedback_data, $data){
		...
		$jq_tmpl_html = "<table align='left' class='jq_mresponse_fdb' width='100%'>
							<tr>
								...
								<td valign='top' width='15%' align='center' class='sectiontableheader'>".JText::_('COM_JQ_YOUR_CHOICE')."</td>
