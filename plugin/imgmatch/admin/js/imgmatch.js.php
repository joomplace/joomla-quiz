...
function jq_uploadImage()
{
	...
	form.plgtask.value = 'upload_resize_img';
	form.submit();
...
function Add_new_tbl_field(elem_field, elem_field2, elem_field3, tbl_id, field_name, field_name2, field_name3) {
	...
	var new_element_txt2 = document.getElementById(elem_field2).options[document.getElementById(elem_field2).selectedIndex].value;
	var new_points = document.getElementById(elem_field3).value;
	document.getElementById(elem_field).options[0].selected = true;
	document.getElementById(elem_field2).options[0].selected = true;
	document.getElementById('imagelib_left').src = '<?php echo JURI::root();?>images/joomlaquiz/images/resize/tnnophoto.jpg';
	document.getElementById('imagelib_right').src = '<?php echo JURI::root();?>images/joomlaquiz/images/resize/tnnophoto.jpg';
	document.getElementById(elem_field3).value = '';
	if (new_element_txt == '') {
		alert("Please select image form the left list");return;
	}
	if (new_element_txt2 == '') {
		alert("Please select image form the right list");return;
	}
	var tbl_elem = document.getElementById(tbl_id);
	...
	cell1.align = 'center';
	cell1.innerHTML = 0;
	cell3.innerHTML = "<img src = '<?php echo JURI::root();?>images/joomlaquiz/images/resize/" + new_element_txt2 + "' width='100' height='100' />";
	cell3.appendChild(input_hidden2);
	cell2.innerHTML = "<img src = '<?php echo JURI::root();?>images/joomlaquiz/images/resize/" + new_element_txt + "' width='100' height='100' />";
