DELETE FROM `#__quiz_t_qtypes` WHERE c_id = '10';
INSERT INTO #__quiz_t_qtypes (c_id, c_qtype, c_type) VALUES (10, 'Multiple question', 'mquestion');
...
CREATE TABLE IF NOT EXISTS `#__quiz_r_student_choice` (
		...
		UPDATE `#__extensions` SET `enabled` = 1 WHERE `element` = 'mquestion';
