DELETE FROM `#__quiz_t_qtypes` WHERE c_id = '3';
INSERT INTO #__quiz_t_qtypes (c_id, c_qtype, c_type) VALUES (3, 'True/False', 'truefalse');
...
CREATE TABLE IF NOT EXISTS `#__quiz_r_student_choice` (
		...
		UPDATE `#__extensions` SET `enabled` = 1 WHERE `element` = 'truefalse';
